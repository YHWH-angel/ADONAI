...
class UTXOCacheTracepointTest(BitcoinTestFramework):
    ...
    def test_uncache(self):
        ...
        def handle_utxocache_uncache(_, data, __):
            ...
            try:
                ...
                assert_equal(18 * COIN, event.value)
    ...
    def test_add_spent(self):
        ...
        assert_equal(
            ...
            len(expected_utxocache_adds),
            len(actual_utxocache_adds),
        )
        assert_equal(
            EXPECTED_HANDLE_SPENT_SUCCESS,
            len(expected_utxocache_spents),
            len(actual_utxocache_spents),
        )
        ...
        expected_add_keys = {
            (e["txid"], e["index"], e["height"], e["value"], e["is_coinbase"])

...
const resources = {
  en: {
    translation: {
      ...
      confirmExport: 'Export wallet?',
      confirmImport: 'Import wallet?',
  ...
  es: {
    translation: {
      ...
      confirmExport: '¿Exportar billetera?',
      confirmImport: '¿Importar billetera?',
      walletExported: 'Billetera exportada',

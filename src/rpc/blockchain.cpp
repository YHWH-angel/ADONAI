...
static RPCHelpMan waitfornewblock()
{
    return RPCHelpMan{
        ...
        "Waits for any new block and returns useful info about it.\n"
                ...
                "\nMake sure to use no RPC timeout (adonai-cli -rpcclienttimeout=0)",
                {
        ...
        {RPCResult::Type::OBJ, "", "",
        {
            ...
            {RPCResult::Type::OBJ, "prevout", "(Only if undo information is available)",
            {
                ...
                {RPCResult::Type::OBJ, "scriptPubKey", "",
                {
                    ...
                    {RPCResult::Type::STR, "address", /*optional=*/true, "The Adonai address (only if a well-defined address exists)"},
    ...
    return RPCHelpMan{
        ...
        "Compute per block statistics for a given window. All amounts are in satoshis.\n"
            ...
            RPCResult::Type::OBJ, "", "",
            {
                ...
                {RPCResult::Type::NUM, "feeratio", /*optional=*/true, "Ratio of total fees to subsidy"},
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    const CAmount subsidy{GetBlockSubsidy(pindex.nHeight, chainman.GetParams().GetConsensus())};
    ret_all.pushKV("subsidy", subsidy);
    const double feeratio{subsidy > 0 ? static_cast<double>(totalfee) / subsidy : 0.0};
    ret_all.pushKV("feeratio", feeratio);
...
static RPCHelpMan scanblocks()
{
    return RPCHelpMan{
        ...
        "This call may take several minutes. Make sure to use no RPC timeout (adonai-cli -rpcclienttimeout=0)",
        {
            scan_action_arg_desc,
            scan_objects_arg_desc,
...
static RPCHelpMan getdescriptoractivity()
{
    return RPCHelpMan{
        ...
        "This call may take several minutes. If you encounter timeouts, try specifying no RPC timeout (adonai-cli -rpcclienttimeout=0)",
        {
...
static RPCHelpMan loadtxoutset()
{
    return RPCHelpMan{
        ...
        "The result is a usable adonaid instance that is current with the network tip in a "

...
#ifndef ADONAI_RPC_UTIL_H
#define ADONAI_RPC_UTIL_H
...
/**
 * Parse a json number or string, denoting ADO/kvB, into a CFeeRate (sat/kvB).
 * Reject negative values or rates larger than 1ADO/kvB.
 */

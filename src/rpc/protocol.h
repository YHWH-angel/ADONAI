...
#ifndef ADONAI_RPC_PROTOCOL_H
#define ADONAI_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in adonaid
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Adonai is not connected

...
public:
    CMainParams() {
        ...
        // Mantén (de momento) tus 10 min/14 días, o ajústalo luego:
        ...
        consensus.fPowNoRetargeting = false;
        {
            ...
            tap.bit = 2;
            tap.nStartTime = Consensus::BIP9Deployment::NEVER_ACTIVE;
            tap.nTimeout = Consensus::BIP9Deployment::NO_TIMEOUT;
            tap.min_activation_height = 0;
            tap.period = 2016;
            tap.threshold = 0;
        }
        {
            auto& td = consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY];
            td.bit = 28;
            td.nStartTime = Consensus::BIP9Deployment::NEVER_ACTIVE;
            td.nTimeout = Consensus::BIP9Deployment::NO_TIMEOUT;
            td.min_activation_height = 0;
            td.period = 2016;
            td.threshold = 0;
        }
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 23);   // 'A...' si quieres
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 83);
        base58Prefixes[SECRET_KEY]     = std::vector<unsigned char>(1, 153);
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E}; // puedes cambiar a un set propio

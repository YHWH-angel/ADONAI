...
{
    BOOST_CHECK(TestSplitHost("www.adonaicore.org", "www.adonaicore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.adonaicore.org]", "www.adonaicore.org", 0));
    BOOST_CHECK(TestSplitHost("www.adonaicore.org:80", "www.adonaicore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.adonaicore.org]:80", "www.adonaicore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.adonaicore.org:65536", "www.adonaicore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.adonaicore.org:0", "www.adonaicore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.adonaicore.org:", "www.adonaicore.org:", 0, false));
}
